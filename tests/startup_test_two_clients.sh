...
echo "=== Тест: запуск двух клиентов ==="
...
assert_contains "$CLIENT2_LOG" "[user2] для [Общий чат]: Hello Everyone!"

echo "=== [ SUCCESS ] Тест на подключение клиентов к серверу и отправку сообщения в общий чат пройден! ==="
